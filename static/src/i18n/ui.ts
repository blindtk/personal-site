...
export const ui = {
  pt: {
    ...
    cfanalytics: {
      ...
      byTypeTitle: 'Por tipo de ameaça · 7d',
      tableType: 'tipo (mecanismo)',
      typesEmpty: 'Sem ameaças com tipo identificado na janela.',
      scrollLabelType: 'tabela de ameaças por tipo/mecanismo, com scroll horizontal',
      // Etiquetas legíveis para os nomes crus do threatPathingMap (chave em
      // minúsculas). Chave desconhecida cai para o valor cru no cliente — o
      // painel nunca fica em branco por deriva de schema.
      typeLabels: {
        'user.securitylevel': 'Nível de segurança / reputação IP',
        securitylevel: 'Nível de segurança',
        firewallrules: 'Regras de firewall',
        'firewall.customrule': 'Regra personalizada',
        'firewall.managedrule': 'Regra gerida (WAF)',
        'firewall.api': 'Regra via API',
        waf: 'WAF (regras geridas)',
        owasp: 'OWASP (WAF)',
        ratelimit: 'Rate limiting',
        bic: 'Browser Integrity Check',
        hot: 'Bloqueio a quente (hotlink/ban)',
  ...
  en: {
    ...
    cfanalytics: {
      ...
      byTypeTitle: 'By threat type · 7d',
      tableType: 'type (mechanism)',
      typesEmpty: 'No threats with an identified type in this window.',
      scrollLabelType: 'threats by type/mechanism table, horizontally scrollable',
      // Human-readable labels for the raw threatPathingMap names (lowercased
      // key). An unknown key falls back to the raw value on the client — the
      // panel never goes blank on schema drift.
      typeLabels: {
        'user.securitylevel': 'Security level / IP reputation',
        securitylevel: 'Security level',
        firewallrules: 'Firewall rules',
        'firewall.customrule': 'Custom rule',
        'firewall.managedrule': 'Managed rule (WAF)',
        'firewall.api': 'Rule via API',
        waf: 'WAF (managed rules)',
        owasp: 'OWASP (WAF)',
        ratelimit: 'Rate limiting',
        bic: 'Browser Integrity Check',
        hot: 'Hot block (hotlink/ban)',
