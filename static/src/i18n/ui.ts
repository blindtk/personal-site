...
export const ui = {
  pt: {
    ...
    site: {
      ...
      riskNote: 'Só entram países com pelo menos 100 pedidos nos 7 dias — abaixo disso, a taxa ameaças/pedidos é ruído estatístico (1 ameaça em 3 pedidos = 33%, sem significar nada). É por isto que o painel pode mostrar só um ou dois países mesmo havendo tráfego de mais origens: as outras simplesmente não têm volume suficiente para o rácio dizer algo.',
  ...
  en: {
    ...
    site: {
      ...
      riskNote: 'Only countries with at least 100 requests over the 7 days are included — below that, the threats/requests ratio is statistical noise (1 threat in 3 requests = 33%, meaning nothing). That is why this panel can show just one or two countries even when there is traffic from more origins: the rest simply do not have enough volume for the ratio to say anything.',
