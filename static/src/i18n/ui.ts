...
export const ui = {
  pt: {
    ...
    perimeter: {
      ...
      title: 'Perímetro',
      intro: 'O que a Internet tenta contra este site: os endpoints-isco que só um scanner tocaria de propósito e o mapa das origens desses ataques. Só metadados e agregados — nunca IPs. A vista mais larga da zona (WAF/edge, cache, tráfego) vive no Analytics.',
      ...
      cfMoved: 'As métricas da zona Cloudflare (pedidos, cache, ameaças, firewall) vivem agora na secção',
      cfMovedLink: 'Analytics',
    },
    detections: {
  ...
  en: {
    ...
    perimeter: {
      ...
      title: 'Perimeter',
      intro: 'What the Internet tries against this site: the decoy endpoints only a scanner would touch on purpose, and the map of where those attacks come from. Metadata and aggregates only — never IPs. The wider zone view (WAF/edge, cache, traffic) lives in Analytics.',
      ...
      cfMoved: 'The Cloudflare zone metrics (requests, cache, threats, firewall) now live in the',
      cfMovedLink: 'Analytics',
    },
    detections: {
