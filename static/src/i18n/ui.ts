...
export const ui = {
  pt: {
    ...
    site: {
      ...
      // ----- Analytics -----
      analyticsMetaTitle: 'Analytics — tráfego e ameaças',
      ...
      // ----- Performance -----
      perfMetaTitle: 'Performance — cache, latência e Core Web Vitals',
      ...
      perfCwvBody:
        'LCP, CLS e INP de visitantes reais precisam de um pequeno beacon (novo endpoint no Worker, só agregados e sem PII) — decisão registada no roadmap. Até lá, o desempenho de laboratório é verificável na página Provas (Lighthouse/PageSpeed).',
    ...
    cfanalytics: {
      ...
      scrollLabel: 'tabela de países por ameaças bloqueadas, com scroll horizontal',
      tableCountry: 'país',
      tableThreats: 'ameaças bloqueadas',
      topCountriesEmpty: 'Sem ameaças bloqueadas com país identificado na janela — boas notícias.',
      byStatusTitle: 'Pedidos rejeitados por código HTTP · 7d',
      tableStatus: 'código (4xx/5xx)',
      tableRequests: 'pedidos',
      statusEmpty: 'Sem pedidos rejeitados (4xx/5xx) na janela — boas notícias.',
      scrollLabelStatus: 'tabela de pedidos rejeitados por código HTTP, com scroll horizontal',
      // Etiquetas legíveis para os códigos HTTP de rejeição/erro. Código sem
      // etiqueta cai para o valor cru no cliente — o painel nunca fica em
      // branco se aparecer um código não previsto.
      statusLabels: {
        400: '400 · Pedido inválido',
        401: '401 · Não autenticado',
        403: '403 · Proibido / bloqueado',
        404: '404 · Não encontrado',
        405: '405 · Método não permitido',
        406: '406 · Não aceitável',
        408: '408 · Timeout do pedido',
        409: '409 · Conflito',
        410: '410 · Removido',
        413: '413 · Corpo demasiado grande',
        414: '414 · URI demasiado longo',
        429: '429 · Rate limited',
        451: '451 · Bloqueado por lei',
        499: '499 · Cliente desistiu',
        500: '500 · Erro interno',
        502: '502 · Bad gateway (origem)',
        503: '503 · Indisponível / desafio',
        504: '504 · Timeout da origem',
        520: '520 · Erro desconhecido (origem)',
        521: '521 · Origem em baixo',
        522: '522 · Timeout de ligação (origem)',
        523: '523 · Origem inalcançável',
        524: '524 · Timeout (origem)',
        525: '525 · Falha de handshake SSL',
        530: '530 · Erro 1xxx da Cloudflare',
      } as Record<string, string>,
      byActionTitle: 'Eventos de firewall por ação · 24h',
      bySourceTitle: 'Eventos de firewall por origem · 24h',
      tableAction: 'ação',
      tableSource: 'origem',
      tableEvents: 'eventos',
      ...
      // minúsculas). Valor sem etiqueta cai para o cru — nunca fica em branco.
      actionLabels: {
        managed_challenge: 'Desafio gerido',
        js_challenge: 'Desafio JS',
        jschallenge: 'Desafio JS',
        challenge: 'Desafio (CAPTCHA)',
        block: 'Bloqueado',
        allow: 'Permitido',
        skip: 'Ignorado (skip)',
        log: 'Registado',
        link_maze_injected: 'Labirinto de links (AI Labyrinth)',
        connection_close: 'Ligação fechada',
        force_connection_close: 'Ligação forçada a fechar',
        unknown: 'Outra',
      } as Record<string, string>,
      sourceLabels: {
        firewallcustom: 'Regras personalizadas',
        firewallmanaged: 'Regras geridas (WAF)',
        ratelimit: 'Rate limiting',
        bic: 'Browser Integrity Check',
        hot: 'Proteção de hotlink',
        l7ddos: 'Mitigação DDoS (L7)',
        botfight: 'Bot Fight Mode',
        botmanagement: 'Gestão de bots',
        linkmaze: 'AI Labyrinth (labirinto)',
        uablock: 'Bloqueio por User-Agent',
        zonelockdown: 'Zone Lockdown',
        securitylevel: 'Nível de segurança',
        sanitycheck: 'Verificação de sanidade',
        ipreputation: 'Reputação de IP',
        country: 'Bloqueio por país',
  ...
  en: {
    ...
    site: {
      ...
      // ----- Analytics -----
      analyticsMetaTitle: 'Analytics — traffic and threats',
      analyticsTitle: 'Analytics',
      analyticsIntro:
      ...
      // ----- Performance -----
      perfMetaTitle: 'Performance — cache, latency and Core Web Vitals',
      perfTitle: 'Performance',
      perfIntro:
      ...
      perfCwvTitle: 'Core Web Vitals',
      perfCwvBody:
        'LCP, CLS and INP from real visitors need a small beacon (new Worker endpoint, aggregates only, no PII) — a decision tracked in the roadmap. Until then, lab performance is verifiable on the Evidence page (Lighthouse/PageSpeed).',
    ...
    cfanalytics: {
      ...
      scrollLabel: 'top countries by threats blocked table, horizontally scrollable',
      tableCountry: 'country',
      tableThreats: 'threats blocked',
      topCountriesEmpty: 'No blocked threats with an identified country in this window — good news.',
      byStatusTitle: 'Rejected requests by HTTP status · 7d',
      tableStatus: 'status (4xx/5xx)',
      tableRequests: 'requests',
      statusEmpty: 'No rejected requests (4xx/5xx) in this window — good news.',
      scrollLabelStatus: 'rejected requests by HTTP status table, horizontally scrollable',
      // Human-readable labels for rejection/error HTTP codes. A code with no
      // label falls back to the raw value on the client — the panel never goes
      // blank on an unexpected code.
      statusLabels: {
        400: '400 · Bad request',
        ...
        429: '429 · Rate limited',
        451: '451 · Blocked for legal reasons',
        499: '499 · Client closed request',
        500: '500 · Internal error',
        502: '502 · Bad gateway (origin)',
        503: '503 · Unavailable / challenge',
        504: '504 · Gateway timeout (origin)',
        520: '520 · Unknown error (origin)',
        521: '521 · Origin down',
        522: '522 · Connection timed out (origin)',
        523: '523 · Origin unreachable',
        524: '524 · Timeout (origin)',
        525: '525 · SSL handshake failed',
        530: '530 · Cloudflare 1xxx error',
      } as Record<string, string>,
      byActionTitle: 'Firewall events by action · 24h',
      bySourceTitle: 'Firewall events by source · 24h',
      tableAction: 'action',
      tableSource: 'source',
      tableEvents: 'events',
      ...
      // value with no label falls back to the raw string — never goes blank.
      actionLabels: {
        ...
        skip: 'Skipped',
        log: 'Logged',
        link_maze_injected: 'Link maze injected (AI Labyrinth)',
        connection_close: 'Connection closed',
        force_connection_close: 'Connection force-closed',
        unknown: 'Other',
      } as Record<string, string>,
      sourceLabels: {
        firewallcustom: 'Custom rules',
        firewallmanaged: 'Managed rules (WAF)',
        ratelimit: 'Rate limiting',
        bic: 'Browser Integrity Check',
        ...
        linkmaze: 'AI Labyrinth (link maze)',
