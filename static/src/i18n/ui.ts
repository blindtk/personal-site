...
export const ui = {
  pt: {
    ...
    site: {
      ...
      perfRumTitle: 'Core Web Vitals — utilizadores reais',
      ...
      autoRefresh: 'Atualização automática a cada 60 s',
  ...
  en: {
    ...
    site: {
      ...
      perfRumTitle: 'Core Web Vitals — real users',
