...
export const ui = {
  pt: {
    ...
    site: {
      ...
      planNote:
        'Detalhe por IP, URL, user-agent e ASN de todo o tráfego exige o dataset firewallEventsAdaptiveGroups (Cloudflare Pro+). No plano atual (Free) mostram-se os sinais que a API dá com números reais: ameaças por país e código HTTP — a ação/origem de firewall acumulada a 7 dias fica na tab Tendências.',
