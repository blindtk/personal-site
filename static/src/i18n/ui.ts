...
export const ui = {
  pt: {
    ...
    cfanalytics: {
      ...
      bySourceTitle: 'Por origem / sistema · 7d',
      byActionTitle: 'Por ação da Cloudflare · 7d',
      tableSource: 'origem',
      tableAction: 'ação',
      tableEvents: 'eventos',
      typesEmpty: 'Sem eventos de firewall detalhados na janela.',
      scrollLabelSource: 'tabela de ameaças por origem/sistema, com scroll horizontal',
      scrollLabelAction: 'tabela de ameaças por ação da Cloudflare, com scroll horizontal',
      // Etiquetas legíveis para os valores crus da GraphQL API (chave em
      // minúsculas). Chave desconhecida cai para o valor cru no cliente — o
      // painel nunca fica em branco por deriva de schema.
      sourceLabels: {
        firewallmanaged: 'Regras Geridas (WAF)',
        firewallcustom: 'Regras personalizadas',
        firewallrules: 'Regras personalizadas',
      ...
      actionLabels: {
        ...
        skip: 'ignorado (skip)',
        allow: 'permitido',
        connectionclose: 'ligação fechada',
        forceconnectionclose: 'ligação forçada a fechar',
        unknown: 'outra',
      } as Record<string, string>,
  ...
  en: {
    ...
    cfanalytics: {
      ...
      bySourceTitle: 'By source / system · 7d',
      byActionTitle: 'By Cloudflare action · 7d',
      tableSource: 'source',
      tableAction: 'action',
      tableEvents: 'events',
      typesEmpty: 'No detailed firewall events in this window.',
      scrollLabelSource: 'threats by source/system table, horizontally scrollable',
      scrollLabelAction: 'threats by Cloudflare action table, horizontally scrollable',
      // Human-readable labels for the raw GraphQL API values (lowercased
      // key). An unknown key falls back to the raw value on the client — the
      // panel never goes blank on schema drift.
      sourceLabels: {
      ...
      actionLabels: {
        ...
        forceconnectionclose: 'connection force-closed',
        unknown: 'other',
      } as Record<string, string>,
