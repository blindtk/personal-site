...
function inlineScripts(html) {
  ...
  // `i` no fecho: sem isto, <SCRIPT> em maiúsculas não batia certo (achado
  // do CodeQL, js/bad-tag-filter) — dist/ nunca teria isso, mas o teste
  // deve ser correto independentemente da fonte.
